/** Keep in sync with `wrong-*-flash` animation duration in `../components/timelineSlot/timelineSlot.module.css`. */
export const WRONG_DROP_FLASH_MS = 880;
export const ENDGAME_REVEAL_DELAY_MS = 620;
